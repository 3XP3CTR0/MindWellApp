    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-md mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <MindWellIcon className="w-12 h-12 text-blue-600" />
              <div>
                <h1 className="text-xl font-bold text-gray-800">MindWell</h1>
                <p className="text-xs text-gray-600">{getGreeting()}, {userName}!</p>
              </div>
            </div>
            <button 
      ...
      {showMenu && (
        <>
          ...
          />
          <div 
            className={`fixed top-20 right-4 w-72 bg-white rounded-2xl shadow-2xl z-50 
      ...
      {/* CONTEÚDO PRINCIPAL COM PADDING-TOP */}
